...
public class Main {
    ...
    public static void create_database() {
        System.out.println("sqlite3 db \"CREATE TABLE Students ( first_name varchar(255), last_name varchar(255), DOB date, student_id integer Primary Key );\"");
        ...
        System.out.println("sqlite3 db \"CREATE TABLE Teachers ( first_name varchar(255), last_name varchar(255), teacher_id integer PRIMARY KEY, dob date, department_id integer, FOREIGN KEY (department_id) REFERENCES departments(department_id) );\"");
